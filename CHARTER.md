# Technical Charter (the "Charter") for OpenSharing a Series of LF Projects, LLC

**Adopted June 9, 2026**

This Charter sets forth the responsibilities and procedures for technical contribution to, and oversight of, the OpenSharing open source project, which has been established as OpenSharing a Series of LF Projects, LLC (the "Project"). LF Projects, LLC ("LF Projects") is a Delaware series limited liability company. All contributors (including committers, maintainers, and other technical positions) and other participants in the Project (collectively, "Collaborators") must comply with the terms of this Charter.

## 1. Mission and Scope of the Project

a. The mission of the Project is to develop an open protocol for sharing Data and AI assets, enabling organizations to exchange Agent Skills and AI models across platforms.
...
*This Markdown is a faithful transcription of the executed Technical Charter (DocuSign Envelope ID: 5DD437DB-B4F6-8065-811F-0CB702EDB01B), adopted June 9, 2026. The signed PDF is the authoritative copy and is committed alongside this file as `OpenSharing-Technical-Charter-2026-06-09.pdf`.*
