 ...
 * itself, and prints it. Used by demo-embedded-up.sh to mint the provider token for the local demo;
 * in a real deployment each provider brings the token their catalog issued.
 *
